 ...
 */
public class OAuth2AlipayMiniProgramAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 * 授权类型：支付宝小程序
	 */
	public static final AuthorizationGrantType ALIPAY_MINIPROGRAM = new AuthorizationGrantType("alipay_miniprogram");
	 ...
	 */
	public OAuth2AlipayMiniProgramAuthenticationToken(Authentication clientPrincipal,
			Map<String, Object> additionalParameters, String appid, String code, String scope) {
		super(OAuth2AlipayMiniProgramAuthenticationToken.ALIPAY_MINIPROGRAM, clientPrincipal, additionalParameters);

 ...
 */
@Configuration
public class OAuth2AlipayMiniProgramConfiguration {
	...
	public AlipayMiniProgramService alipayMiniProgramService() {
		return new InMemoryAlipayMiniProgramService(alipayMiniProgramProperties);
	}

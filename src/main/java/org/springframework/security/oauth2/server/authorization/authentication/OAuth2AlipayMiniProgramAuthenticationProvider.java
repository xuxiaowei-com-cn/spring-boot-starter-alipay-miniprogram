 ...
 */
public class OAuth2AlipayMiniProgramAuthenticationProvider implements AuthenticationProvider {
	...
	@Setter
	private AlipayMiniProgramService alipayMiniProgramService;

	public OAuth2AlipayMiniProgramAuthenticationProvider(HttpSecurity builder) {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		OAuth2AlipayMiniProgramAuthenticationToken grantAuthenticationToken = (OAuth2AlipayMiniProgramAuthenticationToken) authentication;
		...
		builder.authorizationGrantType(OAuth2AlipayMiniProgramAuthenticationToken.ALIPAY_MINIPROGRAM);

		AbstractAuthenticationToken abstractAuthenticationToken = alipayMiniProgramService.authenticationToken(
		...
		DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
				...
				.authorizationGrantType(OAuth2AlipayMiniProgramAuthenticationToken.ALIPAY_MINIPROGRAM)
	...
	public boolean supports(Class<?> authentication) {
		return OAuth2AlipayMiniProgramAuthenticationToken.class.isAssignableFrom(authentication);
	}
	...
	private void variableDefaults() {
		if (authorizationService == null) {
			authorizationService = OAuth2AlipayMiniProgramConfigurerUtils.getAuthorizationService(builder);
		}

		if (tokenGenerator == null) {
			tokenGenerator = OAuth2AlipayMiniProgramConfigurerUtils.getTokenGenerator(builder);
		}

		if (alipayMiniProgramService == null) {
			alipayMiniProgramService = OAuth2AlipayMiniProgramConfigurerUtils.getAlipayMiniProgramService(builder);
		}
	}
